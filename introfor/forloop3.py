...
farms = [{"name": "NE farm", "agriculture": ["sheep", "cows", "pigs", "chickens", "llamas", "cats"]},
         ...
         {"agriculture" {"dirt", "rocks"]}]

# each time through the loop
# farm will be equal to one of the dict within the list "farms"

for farm in farms
#print(farm) # this migh tbe a good "first step" after developing the loop
print(farm.get("name", "Unknown Farm"), end=":\n") #this is like saying, "farm['name']"
                                                   #only it will not return an error                                                      
for agri in farm.get("agriculture"):               #from a single "farm" get the list from key "agriculture"     
