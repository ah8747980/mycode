...
def main():
    ...
    setcode = input("What is the code of the card you are trying to lookup (see mtgcards.index for a list of codes)? ").lower()   # collect user input for MTG card set to lookup
